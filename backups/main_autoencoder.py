...
if DATASET == "MNIST":
    from models.mnist_model import BasicMLP, BasicMLP_AnyF
    from models.autoencoder import MNISTAutoEncoder as AutoEncoder
elif DATASET == "CIFAR10":
    from models.cifar10_model import BasicMLP, BasicMLP_AnyF
    from models.autoencoder import CIFAR10AutoEncoder as AutoEncoder
